...
#figure(
  ...
  table(
    ...
    [#heading-name(<risk:r09>)], [La mitigazione effettivamente applicata per questo rischio è la gestione del preprocessing come descritto nella sezione @cap:inclinazione.],
...
Ad ogni modo, il risultato è più che soddisfacente sotto il punto di vista personale; il problema è che non mi è stato possibile testarlo in produzione per mancanza di tempo.\
...
Ad ogni modo, la soddisfazione personale per il progetto è molto alta: non pensavo di riuscire a portare ogni singolo punto alla conclusione e soprattutto di ottenere un'accuratezza così elevata.\
