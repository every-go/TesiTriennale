...
Lo stage mi permetterà di acquisire conoscenze su OCR on-premise, preprocessing documentale,  parsing strutturato di documenti,  orchestrazione Docker, testing comparativo e collaborazione con tutor e stakeholder.

== Vincoli<cap:vincoli>

Il vincolo principale è non utilizzare LLM oppure OCR a pagamento, come ad esempio OpenAI, Mistral e AWS Extract.
